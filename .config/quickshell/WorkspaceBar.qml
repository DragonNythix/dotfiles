...
Item {
    required property var hyprMonitor     // <-- replaces bar.hyprMonitor references
    ...
    Item {
		...
		spacing: 5
			...
			Repeater {
				...
				// Transparent when active — highlight shows through from behind
				...
				// Tell the highlight where to go whenever this pill becomes active
